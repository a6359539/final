...
#define main_Source_main_mainCharacter_h_14_RPC_WRAPPERS \
 ...
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		if (!P_THIS->RsetLR_Validate(Z_Param_val)) \
		{ \
			RPC_ValidateFailed(TEXT("RsetLR_Validate")); \
			return; \
		} \
		P_THIS->RsetLR_Implementation(Z_Param_val); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		if (!P_THIS->RsetFB_Validate(Z_Param_val)) \
		{ \
			RPC_ValidateFailed(TEXT("RsetFB_Validate")); \
			return; \
		} \
		P_THIS->RsetFB_Implementation(Z_Param_val); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=P_THIS->Rattack(); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(float*)Z_Param__Result=P_THIS->RLR(); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(float*)Z_Param__Result=P_THIS->RFB(); \
		P_NATIVE_END; \
	}
